...
//! ## Key algorithm
//!
//! RSA-2048 is generated by default, but that is this SDK's choice, not a PKI
//! limit. [`AnsCsrBuilder::with_key_pair_pem`] takes an existing PKCS#8 key —
//! for certificate renewal, or to use ECDSA — and the RA accepts RSA of at
//! least 2048 bits and ECDSA P-256/P-384.
//!
